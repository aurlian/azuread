...
{
    public class Api1Model : PageModel
    {
        private readonly IConfiguration _configuration;
        private readonly HttpClient _httpClient;

        public Api1Model(IConfiguration configuration, HttpClient httpClient)
        {
        ...
        public async Task OnGet()
        {
            ...
            var response = await _httpClient.PutAsync($"{_configuration["ApiUrl"]}/WeatherForecast?disabled=false", null);
